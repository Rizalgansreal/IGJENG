...
class instagram:
	...
	def logo(self):
		...
		sol().print(nel(komb,style='bold purple',title=f'[bold green]• Menu Cabul •'))
	...
	def methodku(self):
		urut = []
		urut.append(Panel(f"{R2}01{P2}Methode Api[/]",padding=(0,4),style=f"#FFFFFF"))
		urut.append(Panel(f"{R2}02{P2}Methode Ajax[/]",padding=(0,4),style=f"#FFFFFF"))
		urut.append(Panel(f"{R2}03{P2}Methode ApiV2[/]",padding(0,6),style=f"#FFFFFF"))
		self.tol.print(Columns(urut))
